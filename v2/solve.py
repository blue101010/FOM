#!/usr/bin/env python3
"""
CTFT v2 reference engine — proves the proposed schema is executable, not just descriptive.

Loads the v2 collections (techniques, playbooks, indicators, tools), takes a challenge
*fingerprint*, and runs the agent loop from SCHEMA_V2.md section 5:
...
Usage:
    python v2/solve.py                      # runs all example fingerprints
    python v2/solve.py --validate           # also JSON-Schema-validate every object (needs jsonschema)
    python v2/solve.py --index 0            # run a single example
"""
import argparse
import json
import os
